        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ Auth::guard('admin')->user()->photo_url }}" class="user-image" alt="User Image">
                        <span class="hidden-xs">{{ Auth::guard('admin')->user()->lastname }} {{ Auth::guard('admin')->user()->farstname }}</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            ...
                            <p>
                            {{ Auth::guard('admin')->user()->lastname }} {{ Auth::guard('admin')->user()->farstname }}
