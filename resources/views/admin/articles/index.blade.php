...
@section('content')
    <div class="aidify-container">
        ...
        <form method="GET" class="row mb-3">
            <div class="col-md-3">
                <input type="text" name="search" class="form-control" placeholder="جستجوی عنوان..."
            ...
            <tbody>
                @foreach($articles as $item)
                    <tr>
                        ...
                        <td class="d-flex">
                            <a href="{{ route('admin.articles.edit', $item->id) }}" class="btn btn-xs btn-primary">
                                <i class="fa fa-edit"></i>
                            </a>
                            <form action="{{ route('admin.articles.destroy', $item->id) }}" method="POST" class="d-inline">
                                @csrf @method('DELETE')
                                <button onclick="return confirm('حذف شود؟')" class="btn btn-xs btn-danger"><i
